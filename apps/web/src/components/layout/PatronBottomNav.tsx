...
const mainTabs: NavItem[] = [
  ...
  { href: '/reports',   label: 'Raporlar',  icon: BarChart3,       match: ['/reports'] },
];

const moreItems: NavItem[] = [
  { href: '/branches', label: 'Şubeler & Stok', icon: Building2,     match: ['/branches', '/stock', '/products'] },
  { href: '/orders',   label: 'Siparişler',     icon: ShoppingCart,  match: ['/orders', '/transfers', '/suppliers'] },
  { href: '/settings', label: 'Ayarlar',        icon: Settings,      match: ['/settings', '/users'] },
];

// ── Component ─────────────────────────────────────────────────────────────────

export function PatronBottomNav() {
                ...
                return (
                  <Link
                    ...
                    className={cn(
                      ...
                      isActive(item) ? 'text-primary' : 'text-muted-foreground hover:bg-muted',
                    )}
                  >
                    <Icon className="h-5 w-5" />
                    {label}
